...
void rainbowloop() {
    ...
    for (int i = 0; i < img.height(); i++) {
      CRGB col = CHSV(i + loopCounter, 255, 255);
      colour = col.red/8 << 11 | col.green/4 << 5 | col.blue/8;
...
//    img.drawCentreString("12.34 is in font size 6", 80, 92, 2); // Draw text centre at position 80, 90 using font 2
    img.setTextSize(2);
    img.drawCentreString("Bsides", 110, 70, 4);
    img.setTextSize(1);
    img.drawCentreString("2019", 110, 150, 8);
